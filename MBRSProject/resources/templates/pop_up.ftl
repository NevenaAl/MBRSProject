...
const validationSchema = yup.object({
  <#list properties as property>
  ${property.name}: yup.<#if property.type == "double" || property.type == "float">number<#elseif property.type == "String" || property.type == "LocalDate">string<#elseif property.type == "Boolean">boolean<#elseif property.type == "Integer" >.integer<#else>string().required("This field is required.")</#if >,
  </#list>
